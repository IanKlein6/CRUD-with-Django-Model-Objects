...
learners_youngest = Learner.objects.order_by('-dob')[0:2]
print("2. Find top two youngest learners")
print(learners_youngest)

#All learners age from youngest to oldest
learners_all_by_age = Learner.objects.order_by('-dob')
print("All Learners from youngest to oldest")
print(learners_all_by_age)